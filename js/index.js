"use strict"
let keyy = `fe2e28ca321f4b3e8cf64504243107`;
...
{
    let data = await fetch(`https://api.weatherapi.com/v1/forecast.json?key=fe2e28ca321f4b3e8cf64504243107&q=${city}&days=3`);
